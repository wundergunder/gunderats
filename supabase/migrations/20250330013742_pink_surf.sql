/*
  ...
  1. New Tables
    ...
    - companies: Company profile and subscription info
    - team_members: Company team members and roles
    - jobs: Job postings and requirements
    - pipeline_stages: Customizable hiring pipeline stages
    - candidates: Candidate information and status
    - candidate_stages: Track candidate progress through pipeline
    - comments: Comments on candidates
    - documents: Document metadata for resumes, etc.
