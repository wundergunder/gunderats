...
DROP POLICY IF EXISTS "Allow registration to create companies" ON companies;
DROP POLICY IF EXISTS "Allow registration to create team members" ON team_members;
